"""Sphinx configuration for data_processing."""
...
html_title = "data_processing"
html_short_title = "data_processing"

html_theme_options = {
    "sidebar_hide_name": False,
    "navigation_with_keys": True,
    "top_of_page_buttons": ["view", "edit"],
    "source_repository": "https://github.com/preraulab/data_processing/",
    "source_branch": "master",
    "source_directory": "docs/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/preraulab/data_processing",
